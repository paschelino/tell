...
class UriSpec : DescribeSpec({
    it("complexUrlTest") {
        ...
        uri.toString() shouldBe "https://leia.organa@www.example.org:8080/some/path/to/a/resource?some=query&with=params#fragment"
    }
    ...
    it("urlWithoutUserInfoTest") {
        ...
        val fragment = Fragment("fragment")
        val uri: Uri = schema + hierPart + query + fragment
        uri.toString() shouldBe "https://www.example.org:8080/some/path?some=query&with=params#fragment"
    }
    ...
    it("urlWithSimpleHostAndPathTest") {
        ...
        val fragment = Fragment("fragment")
        val uri: Uri = schema + hierPart + query + fragment
        uri.toString() shouldBe "https://www.example.org/some/path?some=query&with=params#fragment"
    }
    ...
    it("urlWithSimpleHostTest") {
        ...
        val fragment = Fragment("fragment")
        val uri: Uri = schema + hierPart + query + fragment
        uri.toString() shouldBe "https://www.example.org?some=query&with=params#fragment"
    }
    ...
    it("urlWithPathTest") {
        ...
        val fragment = Fragment("fragment")
        val uri: Uri = schema + hierPart + query + fragment
        uri.toString() shouldBe "https:/some/path?some=query&with=params#fragment"
    }
})
